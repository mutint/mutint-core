...
(function () {
     ...
     *                                  an optional .mutint-select-count; defaults to the list's
     ...
     */
    window.mutintSelectList = function (list, options) {
        options = options || {};
        ...
        function showCount() {
            if (!controls) { return; }
            var label = controls.querySelector(".mutint-select-count");
            if (label) {
