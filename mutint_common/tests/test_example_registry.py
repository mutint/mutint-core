...
from mutint_common import example_registry
from mutint_common.example_registry import (
...
FIXTURES = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))),
                        "mutint_import", "annotate", "tests", "fixtures")
...
class ExampleRegistryTestCase(TestCase):
    ...
    def test_the_component_defaults_to_the_name_before_example(self):
        ...
        register_example_dataset("mutint-thing-example", "/tmp/nowhere")
    ...
    def test_an_explicit_component_wins(self):
        ...
        self.assertEqual("mutint-thing", get_example_dataset("odd-name")["component"])
