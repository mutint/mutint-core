...
HTML_MUTATION_TABLE_HEADER = """<tr><td>Mutation Type</td><td>Position</td><td>Sequence Change</td><td>Gene</td><td>Protein change</td>"""
...
HTML_MUTATION_TABLE_ROW = """<td>%s<a href="javascript:void(0)" class="shut" style="float:right;display:none;" onclick="deleteRow.call(this)"><img src="/static/DataTables/media/images/close-icon.gif" width="12" height="11"></a></td>"""
...
def get_table_body(seq_experiment_dict, observed_mutations_query_set, request):
    ...
    for mutation in mutations:
        ...
        if mutation.reference_error:    # TODO: what is going on here? What is 'reference_error'?
            ...
            table_row += HTML_MUTATION_TABLE_ROW % mutation.mutation_type
