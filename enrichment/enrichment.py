...
def get_enrichment_mutation_list(reseq_obs_mut_queryset_list):
    mutation_gene_count_dict = _get_mut_gene_count_dict(reseq_obs_mut_queryset_list)
    return _get_enrich_mut_list(reseq_obs_mut_queryset_list, mutation_gene_count_dict)
...
def _get_mut_gene_count_dict(reseq_obs_mut_queryset_list):
    ...
    return mut_gene_count_dict


def _get_enrich_mut_list(reseq_obs_mut_queryset_list,
    ...
    for reseq_obs_mut_queryset in reseq_obs_mut_queryset_list:
        ...
        for observed_mutation in reseq_obs_muts:
            ...
            for gene in mutation_gene_list:
                ...
                if mutation_gene_count_dict[gene] > 1 and observed_mutation.mutation not in enrichment_mutation_list:
