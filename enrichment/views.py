...
# TODO: ensure that the table functionality with checkboxes work.
# TODO: filter out starting-strain mutations
@login_required
def shared_enrichment_mutations(request):
    ...
    # TODO: Have to order the reseqs somehow.
    ...
    #
    # # filter reseq for only those that contain enriched mutation
