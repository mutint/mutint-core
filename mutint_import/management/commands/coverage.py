...
tools were not installed yet.
    ...
    ./mutint coverage            # every experiment
    ./mutint coverage 4          # one experiment
    ./mutint coverage 4 -n       # say what would be built, write nothing
    ./mutint coverage 4 --force  # rebuild even where a track already exists
