...
from mutint_common import plugin_registry
from mutint_import import breseq_folder, reference as reference_io, reference_rename
...
class RenameApplicationTestCase(TestCase):
    ...
    def test_plugins_are_told_what_moved(self):
        """Derived data keyed on a contig name is core's blind spot -- mutint-phylogeny keys
    ...
    def test_a_failing_hook_does_not_undo_a_committed_rename(self):
        ...
        with self.assertLogs("mutint_common.plugin_registry", level="ERROR"):
            self._rename()
