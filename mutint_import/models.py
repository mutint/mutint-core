...
# keep its hands off. See mutint_import/staging.py.
...
class ImportLock(models.Model):
    ...
    **A database row rather than a Python lock**, because the dev server is threaded and a
    ...
    # Free text naming who holds it, for the message the loser is shown and for `./mutint`.
...
class UploadSession(models.Model):
    ...
    # `mutint_import.staging`. Blank is the ordinary import case, which is every session that
