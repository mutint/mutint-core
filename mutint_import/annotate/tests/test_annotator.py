...
fixtures/synthetic.expected.gd was generated once by the real breseq toolchain:
    ...
    python mutint_import/annotate/tests/make_fixtures.py
    gdtools ANNOTATE -f GD --add-html-fields \
        -r mutint_import/annotate/tests/fixtures/synthetic.gbk \
        -o mutint_import/annotate/tests/fixtures/synthetic.expected.gd \
        mutint_import/annotate/tests/fixtures/synthetic.gd
...
class DisplayTest(SimpleTestCase):
    ...
    def test_mediated_deletion_annotation_text(self):
        ...
        # (U+2011), not an ASCII one -- which is exactly what MutInt has always
