...
`mutint_experiment/permissions.py` is the only thing in the product that decides who may read
...
from mutint_experiment.models import UserGroup, UserGroupMembership, Project, ProjectAccess
...
from mutint_experiment.roles import ROLE_ADMIN, ROLE_OWNER, ROLE_READ, ROLE_WRITE
...
class RoleLadderTestCase(TestCase):
    ...
    def test_each_role_grants_exactly_what_it_should(self):
        from mutint_experiment.roles import rank
