...
from mutint_experiment.permissions import grant_project_access, set_primary_owner
from mutint_experiment.roles import ROLE_READ
from mutint_experiment.utils import get_all_user_exps, get_user_projects
...
class DeleteControlsTestCase(TestCase):
    ...
    def test_the_data_deletes_make_you_type_it(self):
        ...
        for url, control, call in (
                ...
                ("/experiment/", 'id="delete-selected"', "mutintDeleteSelected"),
