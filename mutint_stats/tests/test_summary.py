...
`mutint_stats.util` for the purpose. That second implementation is gone: the literals are what
...
from mutint_stats.util import compute_experiment_counts
...
class SummaryTestCase(TestCase):
    ...
    def test_the_counts_reach_the_page(self):
        """`mutint_stats.views` has pushed these four names into the context for a long time and
