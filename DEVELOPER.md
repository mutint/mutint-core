...
This guide moved into the documentation site, alongside the plugin API it kept overlapping
...
plugin against this repo's registries is under **Writing a plugin**.
