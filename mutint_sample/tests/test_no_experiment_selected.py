...
# mutint-compare plugin, and core cannot see a plugin -- there is no plugin discovery in
# standalone mutint-core at all. Its equivalent lives in mutint_compare/tests/.
PAGES = [
    ("/mutations/breseq", "mutint_sample.views.breseq_table", "samples"),
    ("/stats/", "mutint_stats.views", "statistics"),
]
