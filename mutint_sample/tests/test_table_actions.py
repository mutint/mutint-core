...
They are not Compare's -- Compare moved to the mutint-compare plugin and these stayed, because
...
class SharedTableJsTestCase(TestCase):
    ...
    mutint_search has no tests, and the other three are plugin pages core cannot see. So the
