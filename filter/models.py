...
class AleExperimentFilter(models.Model):
    ...
    ignored_mutations = models.CharField(max_length=1000, default='', blank=True)
    starting_strain_mutations = models.CharField(max_length=1000, default='', blank=True)


class GlobalFilter(models.Model):

    ignored_genes = models.CharField(max_length=1000, default='', blank=True)
    ignored_mutations = models.CharField(max_length=1000, default='', blank=True)
