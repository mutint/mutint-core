...
def get_gene_list(mutation_gene_annotation, ref_gene_list):
    """
    ...
    """
    try:
        mutation_gene_str = mutation_gene_annotation.decode("utf-8")
    except AttributeError:
        mutation_gene_str = mutation_gene_annotation
