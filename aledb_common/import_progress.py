...
reporting rather than there being one rule. ``aledb_import.tests.test_import_progress`` pins
each of them.
...
logger = logging.getLogger("aledb_common.import_progress")
...
_sink = contextvars.ContextVar("aledb_import_progress_sink", default=None)
