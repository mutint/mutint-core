"""The version of aledb-core itself.
...
the ALEDB_BRANDING setting and may version itself independently.

Bump it with `./aledb version --bump patch|minor|major`, and tag the release
