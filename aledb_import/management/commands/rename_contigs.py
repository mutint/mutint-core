"""Rename an experiment's sequences to match a reference file, from the shell.
    ...
    ./aledb rename_contigs 4 --ref REL606.gbk          # show the plan, change nothing
    ./aledb rename_contigs 4 --ref REL606.gbk --yes    # do it
    ./aledb rename_contigs 4 --repair                  # recompute identity from the store
