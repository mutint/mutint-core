"""``./aledb import`` -- the shell's half of the Add Data page.
...
`from aledb_import.management.commands import import` it, and nothing needs to.
"""

from django.core.management import BaseCommand, CommandError

from aledb_import.ale_experiment import import_paths, resolve_experiment
