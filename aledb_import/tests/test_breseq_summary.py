...
from aledb_import.upload import _mean_coverage, _read_breseq_summary
...
class ReadBreseqSummaryTestCase(TestCase):
    def test_reads_the_four_statistics(self):
        stats = _read_breseq_summary(FIXTURE_SAMPLE)
    ...
    def test_a_sample_without_the_file_is_not_an_error(self):
        ...
        self.assertIsNone(_read_breseq_summary(empty))
        self.assertIsNone(_read_breseq_summary("/nonexistent/path"))
    ...
    def test_unparseable_json_is_reported_not_raised(self):
        ...
        with self.assertLogs("aledb_import.upload", level="ERROR"):
            self.assertIsNone(_read_breseq_summary(broken))
    ...
    def test_zero_reads_does_not_divide_by_zero(self):
        ...
        stats = _read_breseq_summary(empty_reads)
...
class MeanCoverageTestCase(TestCase):
    ...
    def test_single_reference_is_its_own_average(self):
        ...
        self.assertEqual(_mean_coverage(summary), 42.5)
    ...
    def test_multiple_references_are_length_weighted(self):
        ...
        # (100*900 + 10*100) / 1000
        self.assertEqual(_mean_coverage(summary), 91.0)
    ...
    def test_junction_only_references_are_skipped(self):
        ...
        self.assertEqual(_mean_coverage(summary), 50.0)

    def test_no_references_is_zero_not_an_error(self):
        self.assertEqual(_mean_coverage({}), 0)
        self.assertEqual(_mean_coverage({"references": {"reference": {}}}), 0)
