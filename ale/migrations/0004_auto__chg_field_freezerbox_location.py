...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FreezerBox.location'
        db.alter_column('ale_freezerbox', 'location', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'FreezerBox.location'
        db.alter_column('ale_freezerbox', 'location', self.gf('django.db.models.fields.CharField')(max_length=500))
    ...
    models = {
        ...
        'ale.freezerbox': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '500', 'null': 'True'}),
