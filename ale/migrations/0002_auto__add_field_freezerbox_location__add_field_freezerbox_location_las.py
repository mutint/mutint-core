...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FreezerBox.location'
        db.add_column('ale_freezerbox', 'location',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=500),
                      keep_default=False)

        # Adding field 'FreezerBox.location_last_updated'
        db.add_column('ale_freezerbox', 'location_last_updated',
                      self.gf('django.db.models.fields.DateField')(default='2013-05-02', auto_now=True, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FreezerBox.location'
        db.delete_column('ale_freezerbox', 'location')

        # Deleting field 'FreezerBox.location_last_updated'
        db.delete_column('ale_freezerbox', 'location_last_updated')
    ...
    models = {
        ...
        'ale.freezerbox': {
            ...
            'location_last_updated': ('django.db.models.fields.DateField', [], {'default': "'2013-05-02'", 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
