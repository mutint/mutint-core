...
Separate from `aledb_sample.urls` because that module is mounted at `^mutations/`, which is the
...
import aledb_sample.views.table_actions


urlpatterns = [
    re_path(r'^toggle-mut-tag/$', aledb_sample.views.table_actions.save_mut_tag,
            name='toggle_mut_tag'),
    re_path(r'^toggle-rep-tag$', aledb_sample.views.table_actions.save_rep_tag,
            name='toggle_rep_tag'),
]
