...
import aledb_sample.views.alignments
...
urlpatterns = [
    ...
    re_path(r'^browse/at$', aledb_sample.views.browse.browse_at, name='browse_at'),
    ...
    re_path(r'^ncbi$', aledb_sample.views.ncbi_view.ncbi_view, name='ncbi_view'),
    re_path(r'^ncbi/check$', aledb_sample.views.ncbi_view.ncbi_check, name='ncbi_check'),
    ...
    re_path(r'^reference$', aledb_sample.views.ncbi_view.reference_view, name='reference_view'),

    # Managed-store files, addressed by primary key and streamed with Range support.
    re_path(r'^alignments/(?P<sample_id>\d+)/bam$',
            aledb_sample.views.alignments.sample_bam, name='sample_bam'),
    re_path(r'^alignments/(?P<sample_id>\d+)/bai$',
            aledb_sample.views.alignments.sample_bai, name='sample_bai'),
    re_path(r'^alignments/(?P<sample_id>\d+)/bigwig$',
            aledb_sample.views.alignments.sample_bigwig, name='sample_bigwig'),
    re_path(r'^reference/(?P<experiment_id>\d+)/fasta$',
            aledb_sample.views.alignments.reference_fasta, name='reference_fasta'),
    re_path(r'^reference/(?P<experiment_id>\d+)/fai$',
            aledb_sample.views.alignments.reference_fai, name='reference_fai'),
    re_path(r'^reference/(?P<experiment_id>\d+)/gff3$',
            aledb_sample.views.alignments.reference_gff3, name='reference_gff3'),
    re_path(r'^reference/(?P<experiment_id>\d+)/chromalias$',
            aledb_sample.views.alignments.reference_chromalias, name='reference_chromalias'),
]
