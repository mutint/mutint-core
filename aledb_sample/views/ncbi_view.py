...
Nothing is drawn until the contig has been verified against NCBI -- see `aledb_sample.ncbi`. The
...
from aledb_sample.models import ExperimentReference, Mutation, MutationCall, NcbiSequence
