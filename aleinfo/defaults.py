...
ALLOWED_HOSTS = [os.environ.get('DJANGO_SERVER_HOST', 'localhost'), 'localhost', '127.0.0.1', 'aledb.org']
...
DATABASES = {
    ...
    'dtu_machine_one': {
        ...
        'PORT': int(os.environ.get('DTU_MACHINE_ONE_MYSQL_PORT', 4407)),
    },
    'dtu_machine_two': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': os.environ.get('DTU_MACHINE_TWO_DATABASE', 'database'),
        'USER': os.environ.get('DTU_MACHINE_TWO_USER', 'user'),
        'PASSWORD': os.environ.get('DTU_MACHINE_TWO_PASSWORD', 'password'),
        'HOST': os.environ.get('DTU_MACHINE_TWO_HOST', 'db'),
        'PORT': int(os.environ.get('DTU_MACHINE_TWO_MYSQL_PORT', 4408)),
    },
    'dtu_machine_three': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': os.environ.get('DTU_MACHINE_THREE_DATABASE', 'database'),
        'USER': os.environ.get('DTU_MACHINE_THREE_USER', 'user'),
        'PASSWORD': os.environ.get('DTU_MACHINE_THREE_PASSWORD', 'password'),
