...
class TestDeletingTheAncestorSample(SubtractionTestCase):
    ...
    def test_it_marks_everything_stale(self):
        ...
        aledb-phylogeny's cached trees would still have been inferred with these mutations
        ...
        """
        from aledb_common.rebuild_registry import (is_stale, register_rebuilder,
