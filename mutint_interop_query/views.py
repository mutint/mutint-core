...
from mutint_sample.util import get_ordered_reseq_dict, get_ordered_reseq_queryset
...
#: `mutint_metadata.views.get_sample_info_list`, shared with the `/metadata` page; that page
